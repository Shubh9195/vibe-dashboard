...
export default function StudyNotes() {
  ...
  const notesData = [
    { id: 1, subject: "Indian Polity", topic: "Fundamental Rights (Articles 12-35)", readTime: 8, tags: ["UPSC", "SSC"] },
    { id: 2, subject: "Geography", topic: "River Systems of India", readTime: 12, tags: ["UPSC", "State PSC"] },
    { id: 3, subject: "History", topic: "Indian National Movement (1885-1947)", readTime: 15, tags: ["All Exams"] },
    { id: 4, subject: "Economy", topic: "Five Year Plans & NITI Aayog", readTime: 10, tags: ["Banking", "SSC"] },
    { id: 5, subject: "General Science", topic: "Vitamins and Deficiency Diseases", readTime: 5, tags: ["RRB", "SSC"] }
  ];
    ...
    <div className="max-w-6xl mx-auto px-4 py-8">
      <div className="bg-slate-900 rounded-3xl p-8 lg:p-12 text-white mb-8 relative overflow-hidden">
        <div className="relative z-10">
          ...
          <h1 className="text-3xl lg:text-5xl font-black mb-4 tracking-tight">Premium Study Notes</h1>
          <p className="text-slate-400 text-lg max-w-2xl">Concise, exam-oriented notes prepared by toppers. Skip the heavy textbooks and read exactly what comes in the exam.</p>
        </div>
      </div>
