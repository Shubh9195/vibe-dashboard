    ...
    <div className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full bg-white p-8 rounded-2xl shadow-xl shadow-slate-200 border border-slate-100">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-slate-500 font-medium mt-2">Start your preparation journey with Sarkari Campus.</p>
        </div>
        ...
        <form className="space-y-5" action={signup}>
          ...
          <div>
            <label className="block text-sm font-bold text-slate-700 mb-1">Which institute are you targeting?</label>
            <select name="examChoice" required className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-600 outline-none transition font-medium text-slate-700 bg-white">
              ...
              <option value="IIT Non-Teaching">IIT Non-Teaching</option>
              <option value="NIT Admin">NIT Admin / Staff</option>
              <option value="NFSU Recruitments">NFSU Special Drives</option>
              <option value="RRU Staff">RRU Vacancies</option>
              <option value="Central Universities">Central Universities (CUET-NT)</option>
              <option value="Other">Other Government Institute</option>
            </select>
          </div>
